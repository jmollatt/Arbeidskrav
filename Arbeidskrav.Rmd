...
Maksimalt oksygenopptak ble først beskrevet av Hill og Lupton i 1923, og kan defineres som kroppens evne til å ta opp og forbruke oksygen per tidsenhet [@HillLupton; @BassetHowley].<!-- Jag la till dessa referenser, använd den inbyggda referenshandteringen för bästa resultat. Era andra referenser kan läggas till i dokuemnetet referenser.bib i bibtex-format, https://www.bioinformatics.org/texmed/ kan användas för att lasta ner dessa -->
Innen toppidrett måles ofte det maksimale oksygenopptaket for å måle utøverens kapasitet opp mot arbeidskravet i den spesifikke idretten, og det maksimale oksygenopptaket kan i så måte også sees på som et mål på den aerobe effekten til utøveren (Bahr et al 1992)<!-- Fixa referensen -->. I Olympiatoppens testprotokoller benytter de flere definerte hjelpekriterier for å sikre at man faktisk har funnet deltakerens maksimale oksygenopptak. Følgende kriterier er beskrevet; platå i &#775;V<sub>O2</sub><!-- Specialtecken och formatteringar kan läggas till i markdown med unicode och html-tecken --> er oppnådd, økning i ventilasjon med utflating av &#775;V<sub>O2</sub> verdi, RER over 1.10/1.05<!-- Vilken gäller? -->, og blodlaktat over 8 (Tønnesen et al, 2017)<!-- Lägg till referens -->.


## Metode

I forkant av testen målte alle deltakerne kroppsvekten i samme klær som ble brukt under testen, men ble bedt om å ta av seg skoene. Kroppsvekten som senere brukt i beregningen av maksimalt oksygenopptak (ml kg<sup>-1</sup> min<sup>-1</sup>) er kroppsvekten målt i forkant av test, etter at 300g har blitt trukket av for å ta høyde for vekten av klærne.<!-- Gör vi verkligen så här, verkar lite godtyckligt? --> For å sikre intern validitet ble deltakerne bedt om å avstå fra anstrengende fysisk aktivitet dagen før test, standardisere måltidet i forkant av test samt avstå fra inntak av koffein under de siste 12 timene før testen [@halperin]. Pre- og post-tester ble
